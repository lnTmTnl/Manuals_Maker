...
function Script(editor) {
  ...
  container.blocklyDisplay = ref(true)
  ...
  close.onClick(function () {
    container.setDisplay("none")
    container.blocklyDisplay.value = false
  })
  header.add(close)
  ...
  container.signals = signals
  container.codemirror = codemirror
  ...
  signals.editScript.add(function (object, script) {
    ...
    if (typeof script === "object") {
      mode = "javascript"
      name = script.name //脚本名称
      source = script.source //脚本代码
    ...
    container.blocklyDisplay.value = true
  })
